*Remember to install cryptography via pip


ByTalk is a minimal, cross-platform, peer-to-peer chat application built for privacy and simplicity.

It runs directly in the terminal - on both Linux and Termux - allowing users to chat securely without any centralized server.
